# Generated by Powerlevel10k configuration wizard on 2024-01-08 at 16:55 +03.
...
() {
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%70F⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%215F⇡$P9K_IP_TX_RATE }%38F'
